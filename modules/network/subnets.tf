...
resource "oci_core_subnet" "masters" {
  ...
  display_name               = "${var.olcne_general.label_prefix}-masters"
  dns_label                  = "masters"
  prohibit_public_ip_on_vnic = true
  route_table_id             = var.olcne_network_vcn.nat_route_id
...
resource "oci_core_subnet" "workers" {
  ...
  compartment_id             = var.olcne_general.compartment_id
  display_name               = "${var.olcne_general.label_prefix}-workers"
  dns_label                  = "workers"
  prohibit_public_ip_on_vnic = true
  route_table_id             = var.olcne_network_vcn.nat_route_id
  vcn_id                     = var.olcne_network_vcn.vcn_id
...
resource "oci_core_subnet" "int_lb" {
  ...
  compartment_id             = var.olcne_general.compartment_id
  display_name               = "${var.olcne_general.label_prefix}-int-lb"
  dns_label                  = "intlb"
  prohibit_public_ip_on_vnic = true
  route_table_id             = var.olcne_network_vcn.nat_route_id
  vcn_id                     = var.olcne_network_vcn.vcn_id
...
resource "oci_core_subnet" "pub_lb" {
  ...
  compartment_id             = var.olcne_general.compartment_id
  display_name               = "${var.olcne_general.label_prefix}-pub-lb"
  dns_label                  = "publb"
  prohibit_public_ip_on_vnic = false
  route_table_id             = var.olcne_network_vcn.ig_route_id
  vcn_id                     = var.olcne_network_vcn.vcn_id
}
