...
output "master_subnet_dns_label" {
  value = "${oci_core_subnet.masters.dns_label}.${data.oci_core_vcn.vcn.dns_label}.oraclevcn.com"
}

# output "operator_subnet_dns_label" {
#   value = "${oci_core_subnet.operator.dns_label}.${data.oci_core_vcn.vcn.dns_label}.oraclevcn.com"
# }

output "worker_subnet_dns_label" {
  value = "${oci_core_subnet.workers.dns_label}.${data.oci_core_vcn.vcn.dns_label}.oraclevcn.com"
}
